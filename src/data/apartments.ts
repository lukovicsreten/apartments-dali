...
export const APARTMENTS: Apartment[] = [
  {
    ...
    description: {
      sr: 'U dobro opremljenoj kuhinji gosti imaju na raspolaganju ploču za kuvanje, frižider, posuđe i aparat za kafu i čaj. Studio takođe poseduje pribor za roštilj. Ovaj klimatizovani studio uključuje flat-screen TV sa striming servisima, privatno kupatilo, kao i terasu sa pogledom na vrt. Uz apartman je obezbeđeno besplatno parking mesto. Jedinica nudi 2 kreveta i smešta do 4 gosta.',
      en: 'Guests will find a stovetop, a refrigerator, kitchenware and a tea and coffee maker in the well-fitted kitchen. The studio also has a barbecue. This air-conditioned studio includes a flat-screen TV with streaming services, a private bathroom as well as a terrace with garden views. A free parking space is available on site. The unit offers 2 beds and sleeps up to 4 guests.',
      de: 'In der gut ausgestatteten Küche finden Gäste ein Kochfeld, einen Kühlschrank, Küchenutensilien sowie eine Kaffee- und Teemaschine. Das Studio verfügt außerdem über eine Grillausstattung. Dieses klimatisierte Studio bietet einen Flachbildfernseher mit Streaming-Diensten, ein eigenes Badezimmer sowie eine Terrasse mit Gartenblick. Ein kostenloser Parkplatz steht vor Ort zur Verfügung. Die Einheit verfügt über 2 Betten und bietet Platz für bis zu 4 Gäste.',
    },
    ...
    amenities: {
      ...
      general: ['tvStreaming', 'ac', 'iron', 'seatingArea', 'extraLongBeds', 'heating', 'privateEntrance', 'freeParking', 'soundproof', 'tileFloor', 'mosquitoNet', 'wardrobe', 'clothesRack', 'sofaBed', 'clothesDryer', 'sofa', 'trashCans', 'crib', 'bedsideOutlet', 'hypoallergenicPillows', 'wakeUpService', 'towels', 'linens', 'keyAccess', 'groundFloorUnitStairs', 'separateBuilding'],
  ...
  },
  {
    ...
    amenities: {
      kitchen: ['coffeeTeaMaker', 'fridge', 'electricKettle', 'kitchenware', 'stovetop', 'bbq', 'diningTable', 'gardenFurniture', 'outdoorDining', 'waterBottle', 'wineGlasses'],
      bathroom: ['shower', 'hairdryer', 'freeToiletries', 'toilet', 'bathOrShower', 'extraToilet', 'toiletPaper', 'shampoo', 'conditioner', 'bodySoap'],
      general: ['tvCable', 'ac', 'acSingleRoom', 'iron', 'seatingArea', 'extraLongBeds', 'heating', 'privateEntrance', 'freeParking', 'soundproof', 'tileFloor', 'wardrobe', 'cleaningProducts', 'clothesRack', 'clothesDryer', 'trashCans', 'bedsideOutlet', 'hypoallergenicPillows', 'wakeUpService', 'towels', 'linens', 'keyCardAccess', 'groundFloorUnit', 'separateBuilding', 'handSanitizer'],
      safety: ['outletCovers'],
    },
  },
  {
    ...
    description: {
      sr: 'U dobro opremljenoj čajnoj kuhinji gosti imaju na raspolaganju ploču za kuvanje, frižider, posuđe i aparat za kafu i čaj. Studio takođe uključuje pribor za roštilj. Ovaj klimatizovani studio čine flat-screen TV sa kablovskim kanalima, privatno kupatilo, kao i terasa sa pogledom na vrt. Uz apartman je obezbeđeno besplatno parking mesto. Jedinica ima 1 krevet i smešta do 3 gosta.',
      en: 'Guests will find a stovetop, a refrigerator, kitchenware and a tea and coffee maker in the well-equipped kitchenette. The studio also includes a barbecue. This air-conditioned studio is comprised of a flat-screen TV with cable channels, a private bathroom as well as a terrace with garden views. A free parking space is available on site. The unit has 1 bed and sleeps up to 3 guests.',
      de: 'In der gut ausgestatteten Küchenzeile finden Gäste ein Kochfeld, einen Kühlschrank, Küchenutensilien sowie eine Kaffee- und Teemaschine. Das Studio verfügt zudem über eine Grillausstattung. Dieses klimatisierte Studio besteht aus einem Flachbildfernseher mit Kabelprogrammen, einem eigenen Badezimmer sowie einer Terrasse mit Gartenblick. Ein kostenloser Parkplatz steht vor Ort zur Verfügung. Die Einheit hat 1 Bett und bietet Platz für bis zu 3 Gäste.',
    },
    childrenNote: childrenNoteMax1,
    capacity: 3,
    sizeM2: 20,
  ...
  },
  {
    ...
    description: {
      sr: 'Ovaj svetao apartman, u potpunosti smešten u prizemlju, ima potpuno opremljenu kuhinju sa pločom za kuvanje, frižiderom i posuđem, kao i privatno kupatilo i udoban krevet na rasklapanje. Gosti mogu da uživaju uz flat-screen TV, klima-uređaj i grejanje, dok sopstveni ulaz vodi na mirnu ulicu. Uz apartman je obezbeđeno besplatno parking mesto. Apartman ima 1 spavaću sobu i smešta do 5 gostiju.',
      en: 'Set entirely on the ground floor, this bright apartment features a fully equipped kitchen with a stovetop, refrigerator and kitchenware, plus a private bathroom and a comfortable sofa bed. Guests can relax with a flat-screen TV, air conditioning and heating, while the private entrance opens onto a quiet street. A free parking space is available on site. The apartment offers 1 bedroom and sleeps up to 5 guests.',
      de: 'Dieses helle, vollständig im Erdgeschoss gelegene Apartment verfügt über eine komplett ausgestattete Küche mit Kochfeld, Kühlschrank und Küchenutensilien sowie ein eigenes Badezimmer und ein bequemes Schlafsofa. Gäste genießen einen Flachbildfernseher, Klimaanlage und Heizung, während der private Eingang zu einer ruhigen Straße führt. Ein kostenloser Parkplatz steht vor Ort zur Verfügung. Das Apartment verfügt über 1 Schlafzimmer und bietet Platz für bis zu 5 Gäste.',
    },
    childrenNote: childrenNoteMax2,
    capacity: 5,
    sizeM2: 40,
  ...
  },
  {
    ...
    amenities: {
      ...
      bathroom: ['shower', 'hairdryer', 'freeToiletries', 'toilet', 'bathOrShower', 'extraToilet', 'toiletPaper', 'shampoo', 'conditioner', 'bodySoap'],
      general: ['tvCable', 'ac', 'iron', 'desk', 'seatingArea', 'extraLongBeds', 'heating', 'connectingRooms', 'privateEntrance', 'freeParking', 'sofa', 'soundproof', 'tileFloor', 'mosquitoNet', 'wardrobe', 'cleaningProducts', 'clothesRack', 'sofaBed', 'clothesDryer', 'trashCans', 'crib', 'bedsideOutlet', 'hypoallergenicPillows', 'wakeUpService', 'towels', 'linens', 'keyAccess', 'groundFloorUnitStairs', 'separateBuilding'],
